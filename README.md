...
<br><br>
The grid of buttons (either on the screen or a connected [monome](monome.org) [grid](https://monome.org/docs/grid/) using the [monomeSC](https://github.com/monome/monomeSC) library) works this way:<br>
